...
# Your job is to extract the MOST RELEVANT academic topic from the question.

# Rules:
# - Output ONLY 1 short topic name
# - Maximum 2–3 words
# - No explanations
# - No sentences
# - No punctuation
...
# Q: Explain normalization in databases
# A: DBMS

# Q: What is overfitting in machine learning?
# A: Machine Learning

# Q: Explain process scheduling
# A: Operating Systems
...
#     [Graph Theory, Arrays, Trees, DP, OS, DBMS, General]

#     Question: {question}

#     Return ONLY the topic name (no extra words).

#     """

#     response = llm.generate_text(prompt).strip()

#     return response.replace("Topic:", "").strip()
